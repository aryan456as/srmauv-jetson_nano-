...
Controller::Controller(){
	...
	usleep(1000000); // Changed from sleep(1) to usleep(1000000) for microseconds
	controller->setPWM(TD1, 0, 290);usleep(1000000);	
    controller->setPWM(TD2, 0, 290);usleep(1000000);
    controller->setPWM(TD3, 0, 290);usleep(1000000);
    controller->setPWM(TD4, 0, 290);usleep(1000000);
    controller->setPWM(TFL, 0, 290);usleep(1000000);
    controller->setPWM(TFR, 0, 290);usleep(1000000);
    controller->setPWM(TRR, 0, 290);usleep(1000000);
	controller->setPWM(TRL, 0, 290);usleep(1000000);
